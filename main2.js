    ...
    while (modeloDama != "ESC"){
        switch (modeloDama){
            case "a":
                ...
                let formaPago1 = prompt("Forma de pago: Teclee:(e)Efectivo con 10% descuento, Teclee:(mp)MercadoPago , Teclee:(t) Tarjeta Débito/Crédito");
                if (formaPago1 === "e"){
                    ...
                    while (formaPago1 === "mp" || formaPago1 ==="t"){
                        alert(`Precio Final: ${precioIva1}`);

                        formaPago1 = prompt("Forma de pago: Teclee:(e)Efectivo con 10% descuento, Teclee:(mp)MercadoPago , Teclee:(t) Tarjeta Débito/Crédito");
                    }
            ...
            case "b":
                ...
                let formaPago2 = prompt("Forma de pago: (e)Efectivo/10%descuento, (mp)MercadoPago , (t) Tarjeta Débito/Crédito");
                if (formaPago2 === "e"){
                    ...
                    while (formaPago2 === "mp" || formaPago2 ==="t"){
                        alert(`Precio Final: ${precioIva2}`);

                        formaPago2 = prompt("Forma de pago: Teclee:(e)Efectivo con 10% descuento, Teclee:(mp)MercadoPago , Teclee:(t) Tarjeta Débito/Crédito");
                    }
                            ...
                            case "t":
                                ...
                                switch (cantCuotas3){
                                    ...
                                    case 9:
                                        ...
                                        alert(`El monto final de su compra es de: ${precioFinalTarjeta9} pesos a pagar en: ${cantCuotas3} cuotas de ${valorCuota9} C/U.`);
        ...
        modeloDama = prompt("Ingrese Modelo: a, b , c.")
    }
}else {
    if (producto === "c"){
        ...
        while (modeloCaballero != "ESC"){
            switch (modeloCaballero){ 
                case "a":
                    ...
                    if (formaPago1 === "e"){
                        ...
                        while (formaPago1 === "mp" || formaPago1 ==="t"){
                            ...
                            formaPago1 = prompt("Forma de pago: (e)Efectivo/10%descuento, (mp)MercadoPago , (t) Tarjeta Débito/Crédito");
                        }
                ...
                case "b":
                    ...
                    let precioIva2 = iva(subtotal2,impuesto);
                    let formaPago2 = prompt("Forma de pago: Teclee:(e)Efectivo con 10% descuento, Teclee:(mp)MercadoPago , Teclee:(t) Tarjeta Débito/Crédito");
                    if (formaPago2 === "e"){
                        let precioFinal2 = iva((pagoEfectivo(subtotal2,descuento)),impuesto);
                        alert(`Precio anterior: ${precioIva2}   Precio final Efectivo: ${precioFinal2} `);
                    }else {
                        while (formaPago2 === "mp" || formaPago2 ==="t"){
                            ...
                            formaPago2 = prompt("Forma de pago: (e)Efectivo/10%descuento, (mp)MercadoPago , (t) Tarjeta Débito/Crédito");
                        }
                ...
                case "c":
                    ...
                    let precioIva3 = iva(subtotal3,impuesto);
                    let formaPago3 = prompt("Forma de pago: Teclee:(e)Efectivo con 10% descuento, Teclee:(mp)MercadoPago , Teclee:(t) Tarjeta Débito/Crédito");
                    if (formaPago3 === "e"){
                        let precioFinal3 = iva((pagoEfectivo(subtotal3,descuento)),impuesto);
                        alert(`Precio anterior: ${precioIva3}   Precio final Efectivo: ${precioFinal3} `);
                    }else {
                        while (formaPago3 === "mp" || formaPago3 ==="t"){
                            alert(`Precio Final: ${precioIva3}`);

                            formaPago3 = prompt("Forma de pago: (e)Efectivo/10%descuento, (mp)MercadoPago , (t) Tarjeta Débito/Crédito");
                        }
